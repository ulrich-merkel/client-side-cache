...
(function(b,r,f){function h(a){this.storage=this.controller=null;this.params=a;this.queue=new l;this.timeout=this.interval=this.calls=0}function k(b){var c=null,d=n.length,f;b||(b=z);if(e)for(f=0;f<d;f+=1)a(n[f].params)===a(b)&&(c=n[f]);c||(c=new h(b),n.push(c));return c}function p(a,c,d){var e=k(a),f,h,l=function(){f=e.interval;b.clearInterval(f);f=b.setInterval(function(){e.timeout=h=e.timeout+g;e.controller&&(e.storage&&e.storage.adapter)&&(b.clearInterval(f),e.queue.flush());h>x&&(b.clearInterval(f),
d())},g)};e?e.storage?c(e):(e.queue.add(function(){c(e)}),e.calls+=1,1===e.calls?e.controller=new r.cache.controller(function(a){e.storage=a;e.controller?e.queue.flush():l()},a):l()):d()}var n=[];f=r.helpers;var l=f.queue;f=f.utils;var d=f.isArray,e=f.getJson(),a=f.jsonToString,c=f.callback,g=25,x=5E3,z={};f=function(){return{load:function(a,b,e){b=c(b);p(e,function(c){d(a)?c.controller.load(a,b):"applicationCache"===a?(c=c.storage)&&c.appCacheAdapter?c.appCacheAdapter.open(b,e):b(!1):b(!1)},function(){b(!1)});
return this},remove:function(a,b,e){b=c(b);p(e,function(c){d(a)?c.controller.remove(a,b):b(!1)},function(){b(!1)});return this},setup:function(a){a&&(z=a);return this}}}();r.ns("cache.load",f.load);r.ns("cache.remove",f.remove);r.ns("cache.setup",f.setup)})(window,window.getNs());
