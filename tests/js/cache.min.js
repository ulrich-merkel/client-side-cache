...
e(f):(f.queue.add(function(){e(f)}),f.calls+=1,1===f.calls?f.controller=new r.cache.controller(function(a){f.storage=a;f.controller?f.queue.flush():n()},a):n()):h()}var p=[];k=r.helpers;var l=k.queue;k=k.utils;var n=k.isArray,e=k.jsonToString,a=k.callback,b=25,d=5E3,y={};k=function(){return{load:function(b,c,d){c=a(c);q(d,function(a){n(b)?a.controller.load(b,c):"applicationCache"===b?(a=a.storage)&&a.appCacheAdapter&&!a.appCacheAdapter.opened?a.appCacheAdapter.open(c,d):c(!1):c(!1)},function(){c(!1)});
